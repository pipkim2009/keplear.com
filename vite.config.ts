  ...
  server: {
    ...
    headers: {
      ...
      'Content-Security-Policy':
        "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.youtube.com https://*.youtube.com https://www.google.com https://*.google.com https://w.soundcloud.com https://connect.soundcloud.com https://pagead2.googlesyndication.com https://*.googleadservices.com https://*.googlesyndication.com https://adservice.google.com https://www.googletagmanager.com https://tpc.googlesyndication.com https://cdn.jsdelivr.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: blob: https:; media-src 'self' blob: https://nbrosowsky.github.io https://*.soundcloud.com https://*.sndcdn.com https://*.dzcdn.net https://*.googlevideo.com https://*.youtube.com; connect-src 'self' https://*.supabase.co wss://*.supabase.co https://nbrosowsky.github.io https://api-v2.soundcloud.com https://*.soundcloud.com https://www.youtube.com https://*.youtube.com https://*.google.com https://*.googlevideo.com https://api.piped.private.coffee https://pipedapi.kavin.rocks https://pipedapi.adminforge.de https://piped-api.garudalinux.org https://pipedapi.r4fo.com https://pipedapi.darkness.services https://pipedapi.simpleprivacy.fr https://pagead2.googlesyndication.com https://*.googlesyndication.com https://*.googleadservices.com https://*.doubleclick.net https://cdn.jsdelivr.net https://huggingface.co https://*.huggingface.co https://*.hf.co; frame-src 'self' https://www.youtube.com https://*.youtube.com https://w.soundcloud.com https://googleads.g.doubleclick.net https://tpc.googlesyndication.com https://*.googlesyndication.com; worker-src 'self' blob:; frame-ancestors 'self'; base-uri 'self'; form-action 'self';",
    },
  },
