        ...
        >
          {isPlaying ? (
            <svg viewBox="0 0 24 24" fill="currentColor">
              <path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z" transform="translate(12, 12) scale(1.5) translate(-12, -12)"/>
            </svg>
          ) : (
            <svg viewBox="0 0 24 24" fill="currentColor">
              <path d="M8 5v14l11-7z" transform="translate(12, 12) scale(1.5) translate(-12, -12)"/>
            </svg>
          )}
        </button>
